package ws.wiklund.beerguide.list;
...
import ws.wiklund.guides.util.AlarmReceiver;
...
public class CellarListCursorAdapter extends SimpleCursorAdapter {
	...
	public CellarListCursorAdapter(Context context, Beverage beverage) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
			...
			numberPicker.setOnChangeListener(new OnChangedListener() {
				...
				public void onChanged(NumberPicker picker, int oldVal, int newVal) {
					...
					if(beverage.hasPrice()) {
						holder.priceView.setText(valueString + String.valueOf(newVal * beverage.getPrice()));
		...
		if(beverage.hasPrice()) {
			holder.priceView.setText(valueString + String.valueOf(holder.numberPicker.getCurrent() * beverage.getPrice()));
		}
	...
	private void setReminder(Calendar cal, ViewHolder holder) {
		...
		alarmintent.putExtra("title", String.format(applicationContext.getString(R.string.reminderTitle), new Object[]{holder.cellar.getNoBottles(), beverage.getName()}));
	...
	private int getNextNotificationId() {
		BeerDatabaseHelper helper = new BeerDatabaseHelper(applicationContext);
