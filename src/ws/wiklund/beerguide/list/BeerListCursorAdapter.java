...
public class BeerListCursorAdapter extends SimpleCursorAdapter implements SectionIndexer {
	private LayoutInflater inflator;
	private Map<String, Integer> alphaIndexer;
	private String[] sections;

	public BeerListCursorAdapter(Context context, Cursor c) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
		...
		if (c.moveToPosition(position)) {
			...
			holder.typeView.setText(new BeerTypes().findTypeFromId(c.getInt(3)).toString());
